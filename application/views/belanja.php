                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    <div class="card-product__img">
                                        <img class="card-img" src="<?php echo base_url() . '/uploads/' . $brg->gambar ?>" alt="">
                                        <ul class="card-product__imgOverlay">
                                            <?php echo anchor('belanja/detail/' . $brg->id_brg, '<li><button><i class="ti-search"></i></button></li>') ?>
                                            <?php echo anchor('belanja/tambah_ke_keranjang/' . $brg->id_brg, '<li><button><i class="ti-shopping-cart"></i></button></a></li>') ?>
                                            <li><button><i class="ti-heart"></i></button></li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <p><?php echo $brg->kategori ?></p>
                                        <h4 class="card-product__title"><a href="#"><?php echo $brg->nama_brg ?></a></h4>
                                        <p class="card-product__price badge bg-primary" style="color: white;"><?php echo "Rp " . number_format($brg->harga, 0, ',', '.'); ?></p>
                                        <p class="card-product__price">Stok: <?php echo $brg->stok ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
